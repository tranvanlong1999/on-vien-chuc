...
export const nd93: LawDocument = {
  ...
  shortTitle: 'NĐ 93/2026 - Hướng dẫn Luật Nhà giáo',
  code: '93/2026/NĐ-CP',
  summary: 'Quy định chi tiết và hướng dẫn thi hành Luật Nhà giáo: chức danh nhà giáo, tuyển dụng, điều động, thuyên chuyển, đánh giá, thu hút trọng dụng, nghỉ hè, nghỉ hưu tuổi cao hơn, đào tạo bồi dưỡng.',
  icon: '📋',
  ...
  chapters: [
      ...
      articles: [
        {
          ...
          content: 'Chức danh nhà giáo trong cơ sở giáo dục bao gồm:\n1. Các chức danh giáo viên:\na) Giáo viên mầm non; b) Giáo viên tiểu học; c) Giáo viên trung học cơ sở; d) Giáo viên trung học phổ thông; đ) Giáo viên dự bị đại học; e) Giáo viên giáo dục thường xuyên; g) Giáo viên sơ cấp; h) Giáo viên trung học nghề; i) Giáo viên trung cấp.\n2. Các chức danh giảng viên:\na) Giảng viên cao đẳng: giảng viên, giảng viên chính, giảng viên cao cấp;\nb) Giảng viên đại học: giảng viên, giảng viên chính, giảng viên cao cấp, phó giáo sư, giáo sư;\nc) Giảng viên đào tạo, bồi dưỡng; d) Giảng viên trường chính trị.',
          summary: [
            'Giáo viên: 9 chức danh từ mầm non đến trung cấp.',
            'Giảng viên đại học có 5 bậc: giảng viên → chính → cao cấp → phó giáo sư → giáo sư.',
          ],
          examFocus: 'Nhớ đủ 9 chức danh giáo viên. Giảng viên ĐH có thêm GS và PGS (tổng 5 bậc). Hệ thống chức danh này là cơ sở để xếp lương và đánh giá chuẩn nghề nghiệp.',
          isNew2026: true,
        },
        {
          id: 'nd93-d4',
          number: 'Điều 4',
          title: 'Bổ nhiệm, xếp lương, thay đổi chức danh nhà giáo',
          content: '1. Việc bổ nhiệm chức danh và xếp lương đối với nhà giáo được thực hiện khi tuyển dụng, tiếp nhận và thay đổi vị trí việc làm. Nhà giáo được bổ nhiệm chức danh nào phải đáp ứng chuẩn nghề nghiệp của chức danh đó.\n2. Bổ nhiệm, xếp lương đối với chức danh giáo sư, phó giáo sư:\na) Nhà giáo đáp ứng tiêu chuẩn, điều kiện theo quy định của Bộ trưởng Bộ GD&ĐT được bổ nhiệm chức danh GS, PGS;\nb) Nhà giáo được bổ nhiệm GS, PGS được xếp lương tương ứng chức danh giảng viên cao cấp.\n5. Bộ trưởng Bộ Giáo dục và Đào tạo quy định việc bổ nhiệm và xếp lương đối với các chức danh nhà giáo trong cơ sở giáo dục công lập.',
          summary: [
            'Bổ nhiệm gắn liền với tuyển dụng và thay đổi VTVL; phải đáp ứng chuẩn nghề nghiệp chức danh được bổ nhiệm.',
            'GS/PGS do Bộ trưởng GD&ĐT quy định; xếp lương tương ứng giảng viên cao cấp.',
          ],
          examFocus: 'GS/PGS được bổ nhiệm theo tiêu chuẩn riêng của Bộ trưởng GD&ĐT và xếp lương = GIẢNG VIÊN CAO CẤP. Đây là thông tin hay ra thi.',
        },
      ],
    },
    {
      number: 'Chương III',
      title: 'Tuyển dụng, tiếp nhận nhà giáo',
      articles: [
        {
          id: 'nd93-d5',
          number: 'Điều 5',
          title: 'Căn cứ, thẩm quyền tuyển dụng nhà giáo',
          content: '1. Căn cứ tuyển dụng nhà giáo:\na) Cơ sở giáo dục công lập: phải căn cứ vào chuẩn nghề nghiệp theo chức danh nhà giáo tương ứng với vị trí việc làm dự kiến tuyển dụng và các quy định của pháp luật về viên chức;\nb) Cơ sở giáo dục ngoài công lập: phải căn cứ vào chuẩn nghề nghiệp theo chức danh nhà giáo và quy chế tổ chức và hoạt động của cơ sở giáo dục, đảm bảo công khai, minh bạch.\n2. Thẩm quyền tuyển dụng nhà giáo đối với cơ sở giáo dục nghề nghiệp công lập, cơ sở giáo dục đại học công lập: người đứng đầu cơ sở giáo dục thực hiện tuyển dụng nhà giáo hoặc phân cấp cho các đơn vị thuộc, trực thuộc thực hiện.',
          summary: [
            'Căn cứ tuyển dụng chính: CHUẨN NGHỀ NGHIỆP theo chức danh + quy định về viên chức.',
            'Thẩm quyền: người đứng đầu cơ sở giáo dục ĐH/nghề nghiệp; trường phổ thông do cơ quan quản lý tuyển.',
          ],
          examFocus: 'Chuẩn nghề nghiệp là căn cứ TRỰC TIẾP của tuyển dụng nhà giáo (khác viên chức thông thường chỉ căn cứ vào VTVL).',
          isNew2026: true,
        },
        {
          id: 'nd93-d6',
          number: 'Điều 6',
          title: 'Đối tượng được ưu tiên trong tuyển dụng nhà giáo',
          content: '1. Đối tượng được ưu tiên theo điểm a khoản 3 Điều 14 Luật Nhà giáo:\na) Là người có thời gian làm nhiệm vụ giảng dạy, giáo dục đúng vị trí việc làm cần tuyển dụng hoặc giảng dạy ở cấp học khác nhưng môn học phù hợp với vị trí tuyển dụng từ đủ 03 năm (36 tháng) trở lên, có đóng bảo hiểm xã hội bắt buộc (nếu không liên tục và chưa nhận trợ cấp BHXH 01 lần thì được cộng dồn);\nb) Được cộng 05 điểm vào kết quả điểm vòng 2 kỳ thi hoặc xét tuyển dụng nhà giáo.\n2. Đối tượng ưu tiên về kỹ năng nghề:\na) Có chứng chỉ kỹ năng nghề quốc gia bậc 4 trở lên hoặc có kinh nghiệm làm việc thực tế từ đủ 03 năm trở lên có đóng BHXH bắt buộc;\nb) Được cộng 05 điểm vào kết quả điểm vòng 2.\n4. Trường hợp thuộc nhiều đối tượng ưu tiên khác nhau thì chỉ được cộng điểm ưu tiên CAO NHẤT vào kết quả điểm vòng 2 (không cộng dồn).',
          summary: [
            'Ưu tiên: giảng dạy từ đủ 36 tháng (đóng BHXH bắt buộc) → được cộng 5 điểm vào Vòng 2.',
            'Nhiều đối tượng ưu tiên: chỉ được cộng điểm ưu tiên CAO NHẤT (không cộng dồn).',
          ],
          examFocus: 'Mẹo nhớ: 36 tháng = 5 điểm Vòng 2. Nhiều ưu tiên → chỉ lấy ưu tiên CAO NHẤT. Đây là câu hỏi định lượng hay ra thi.',
          isNew2026: true,
        },
        {
          id: 'nd93-d7',
        ...
        },
        {
          id: 'nd93-d9',
          number: 'Điều 9',
          title: 'Hội đồng tuyển dụng, xác định người trúng tuyển',
          content: '1. Hội đồng tuyển dụng, trình tự, thủ tục, nội quy, quy chế, xác định người trúng tuyển kỳ tuyển dụng nhà giáo trong các cơ sở giáo dục công lập thực hiện theo quy định của pháp luật về tuyển dụng viên chức.\n2. Cơ sở giáo dục ngoài công lập thực hiện tuyển dụng nhà giáo theo trình tự, thủ tục, nội quy, quy chế của cơ sở giáo dục và thực hiện đánh giá năng lực người đăng ký dự tuyển thông qua thực hành sư phạm theo quy định tại khoản 2 Điều 7 Nghị định này. Việc xác định người trúng tuyển do cơ sở giáo dục quyết định theo quy chế tổ chức và hoạt động, bảo đảm công khai, minh bạch.\n3. Các công việc liên quan đến việc ra đề thi, chấm thi phải thực hiện bảo mật theo quy định.',
          summary: [
            'Trường công lập: tuyển theo quy định pháp luật về viên chức (NĐ 259/2026).',
            'Trường tư thục: tự quy định nhưng BẮT BUỘC phải có thực hành sư phạm ở Vòng 2.',
          ],
          examFocus: 'Điểm đáng nhớ: trường TƯ THỤC được tự quyết tuyển dụng nhưng VẪN PHẢI tổ chức thực hành sư phạm ở Vòng 2. Đây là điểm mới của Luật Nhà giáo 2025.',
          isNew2026: true,
        },
        {
          id: 'nd93-d10',
          number: 'Điều 10',
          title: 'Điều kiện, trình tự, thủ tục tiếp nhận nhà giáo trong cơ sở giáo dục công lập',
          content: '1. Điều kiện tiếp nhận nhà giáo:\na) Đối với trường hợp tiếp nhận vào làm viên chức: theo quy định của pháp luật về viên chức;\nb) Đối với đối tượng hưởng chính sách thu hút (vùng khó khăn): đạt chuẩn trình độ đào tạo; tình nguyện đến làm việc tại vùng ĐBDTTS, miền núi, biên giới, hải đảo. Trường hợp tiếp nhận đến vùng ĐBDTTS thì phải sử dụng được tiếng dân tộc thiểu số.\n2. Trình tự, thủ tục tiếp nhận nhà giáo:\na) Thành lập Hội đồng kiểm tra, sát hạch theo thành phần quy định về Hội đồng tuyển dụng viên chức;\nb) Hội đồng kiểm tra văn bằng, chứng chỉ; tổ chức sát hạch bằng phỏng vấn hoặc thực hành sư phạm; làm việc theo nguyên tắc tập thể, quyết định theo đa số;\nc) Người đứng đầu cơ quan có thẩm quyền tuyển dụng ra quyết định tiếp nhận nhà giáo.',
          summary: [
            'Tiếp nhận (không qua thi/xét) nhưng phải qua Hội đồng kiểm tra-sát hạch (phỏng vấn hoặc thực hành sư phạm).',
            'Đối tượng thu hút vùng khó: không cần điều kiện thời gian công tác của tiếp nhận viên chức thông thường.',
          ],
          examFocus: 'Tiếp nhận không phải thi nhưng vẫn phải qua Hội đồng sát hạch. Thu hút vùng khó: không cần điều kiện thời gian công tác (miễn). Vùng ĐBDTTS: phải biết tiếng dân tộc.',
        },
      ],
    },
    {
      number: 'Chương IV',
      title: 'Điều động, thuyên chuyển, dạy liên trường, đánh giá đối với nhà giáo',
      articles: [
        {
          id: 'nd93-d11',
          number: 'Điều 11',
        ...
        },
        {
          id: 'nd93-d12',
          number: 'Điều 12',
          title: 'Thuyên chuyển nhà giáo trong cơ sở giáo dục công lập',
          content: '1. Nguyên tắc thuyên chuyển:\na) Thực hiện khi nhà giáo có nhu cầu; phải được sự đồng ý của cơ sở giáo dục nơi nhà giáo chuyển đi VÀ chuyển đến;\nb) Phù hợp với điều kiện thực tế về vị trí việc làm;\nc) Tuân thủ hướng dẫn và các quy định về thuyên chuyển của cơ quan có thẩm quyền.\n2. Thẩm quyền thuyên chuyển: UBND xã (trong xã); Sở GD&ĐT (trong tỉnh, kể cả giữa 2 xã khác nhau, giữa tỉnh này với tỉnh khác); người đứng đầu cơ sở giáo dục ĐH, nghề nghiệp.\n3. Hồ sơ, trình tự: 30 ngày làm việc tính từ ngày nhận đủ hồ sơ hợp lệ, cơ quan có thẩm quyền ra quyết định thuyên chuyển.',
          summary: [
            'Thuyên chuyển: nhà giáo có nguyện vọng + đồng ý của CẢ 2 bên (nơi đi và nơi đến).',
            'Thời hạn xử lý: 30 ngày làm việc từ khi nhận đủ hồ sơ. Thẩm quyền theo cấp như điều động.',
          ],
          examFocus: 'Thuyên chuyển: 2 điều kiện quan trọng — (1) nguyện vọng cá nhân + (2) đồng ý của CẢ 2 bên. Thời hạn 30 ngày làm việc.',
        },
        {
          id: 'nd93-d13',
          number: 'Điều 13',
          title: 'Dạy liên trường, liên cấp đối với nhà giáo trong cơ sở giáo dục công lập',
          content: '1. Nguyên tắc:\na) Thực hiện trên cơ sở xem xét tính hợp lý về điều kiện địa lý, hoàn cảnh thực tế của nhà giáo và ý kiến của người đứng đầu các cơ sở giáo dục;\nb) Cơ sở giáo dục phối hợp tạo điều kiện về thời gian, bố trí nhiệm vụ phù hợp.\n2. Thẩm quyền phân công: Sở GD&ĐT/UBND cấp xã (trường phổ thông); người đứng đầu (trường ĐH, nghề nghiệp).\n3. Chế độ, chính sách:\na) Số tiết dạy là tổng số tiết ở các cơ sở giáo dục được phân công;\nb) Đánh giá do người đứng đầu cơ sở quản lý nhà giáo thực hiện, trên cơ sở nhận xét của nơi dạy liên trường;\nc) Lương và chế độ theo lương do cơ sở giáo dục có thẩm quyền quản lý nhà giáo chi trả; tiền dạy thêm giờ và phụ cấp lưu động thực hiện theo quy định.',
          summary: [
            'Dạy liên trường: số tiết được tính tổng; lương do trường QUẢN LÝ chi trả (không phải trường nhận dạy).',
            'Đánh giá: trường quản lý đánh giá dựa trên nhận xét của trường nhận dạy liên trường.',
          ],
          examFocus: 'Khi dạy liên trường: TRƯỜNG GỐC (quản lý) trả lương; TRƯỜNG NHẬN cung cấp nhận xét; số tiết tính tổng cộng.',
        },
        {
          id: 'nd93-d14',
          number: 'Điều 14',
          title: 'Đánh giá nhà giáo theo chuẩn nghề nghiệp',
          content: '1. Nội dung đánh giá nhà giáo theo chuẩn nghề nghiệp gồm:\na) Đạo đức nhà giáo và việc chấp hành quy tắc ứng xử của nhà giáo;\nb) Trình độ đào tạo, bồi dưỡng;\nc) Năng lực chuyên môn, nghiệp vụ theo yêu cầu của chức danh gắn với vị trí việc làm.\n2. Kết quả đánh giá nhà giáo theo chuẩn nghề nghiệp được sử dụng làm căn cứ để thực hiện đánh giá nhà giáo theo quy định tại khoản 1 Điều 22 Luật Nhà giáo (đánh giá định kỳ theo năm học).\n3. Tiêu chí xếp loại:\na) Nhà giáo trong cơ sở giáo dục công lập: đáp ứng tiêu chí đánh giá, xếp loại chất lượng viên chức theo quy định;\nb) Nhà giáo ngoài công lập: theo quy chế đánh giá, xếp loại của cơ sở giáo dục.',
          summary: [
            'Đánh giá theo 3 nội dung: đạo đức + quy tắc ứng xử; trình độ đào tạo; năng lực chuyên môn.',
            'Nhà giáo công lập áp dụng quy định đánh giá viên chức; ngoài công lập theo quy chế riêng.',
          ],
          examFocus: 'Đánh giá nhà giáo = chuẩn nghề nghiệp (3 nội dung) + tiêu chí viên chức. Kết quả là căn cứ để đánh giá viên chức theo Luật Nhà giáo Điều 22.',
        },
      ],
    },
    {
      number: 'Chương V',
      title: 'Chính sách thu hút, trọng dụng đối với nhà giáo, chế độ nghỉ hưu',
      articles: [
        {
          id: 'nd93-d15',
          number: 'Điều 15',
          title: 'Đối tượng hưởng chính sách thu hút, trọng dụng đối với nhà giáo',
          content: '1. Đối tượng được hưởng chính sách thu hút, trọng dụng gồm:\na) Người có tài năng (theo NĐ 179/2024/NĐ-CP);\nb) Giáo sư, phó giáo sư hoặc người được công nhận đạt tiêu chuẩn chức danh GS, PGS;\nc) Người đạt thành tích cao cấp quốc gia, quốc tế trong văn hóa, nghệ thuật, thể thao;\nd) Nghệ nhân ưu tú, Nghệ sĩ ưu tú, Thầy thuốc ưu tú, Nghệ nhân nhân dân; người có chứng chỉ kỹ năng nghề quốc gia bậc 4 trở lên;\nđ) Người đến làm việc tại vùng đồng bào dân tộc thiểu số, miền núi, biên giới, hải đảo và vùng đặc biệt khó khăn;\ne) Nhà giáo trong lĩnh vực trọng yếu, thiết yếu theo nhu cầu phát triển kinh tế - xã hội;\ng) Nhà giáo dạy ngành, nghề khó tuyển sinh nhưng xã hội có nhu cầu hoặc ngành đặc thù (nghệ thuật, thể thao, y tế, quốc phòng, an ninh).',
          summary: [
            '7 nhóm đối tượng được thu hút-trọng dụng: người tài, GS-PGS, thành tích cao, nghệ nhân, vùng khó, lĩnh vực trọng yếu, ngành đặc thù.',
            'Diện thu hút rộng hơn so với trước - bao gồm cả ngành khó tuyển sinh và đặc thù.',
          ],
          examFocus: '7 nhóm đối tượng thu hút. Nhớ: GS/PGS, người tài năng, vùng khó khăn, lĩnh vực trọng yếu là 4 nhóm hay ra thi.',
          isNew2026: true,
        },
        {
          id: 'nd93-d16',
        ...
        },
        {
          ...
          examFocus: 'Nghỉ hè: MN/PT = 8 tuần; GDTX = 4-8 tuần; Sơ cấp = 4 tuần; TC/CĐ = 6 tuần. Nghỉ hè bao gồm cả nghỉ phép năm.',
          isNew2026: true,
        },
        {
          id: 'nd93-d18',
          number: 'Điều 18',
          title: 'Quy trình, thủ tục nghỉ hưu ở tuổi cao hơn',
          content: '1. Hằng năm, cơ sở giáo dục công lập thông báo chủ trương, nhu cầu sử dụng nhà giáo nghỉ hưu ở tuổi cao hơn.\n2. Hồ sơ đề nghị: đơn đề nghị của nhà giáo; hồ sơ viên chức; tài liệu minh chứng đáp ứng điều kiện.\n3. Nhà giáo đáp ứng điều kiện nộp hồ sơ trước thời điểm nghỉ hưu ít nhất 06 tháng. Trong thời hạn 30 ngày làm việc kể từ ngày nhận đủ hồ sơ, cơ sở giáo dục xem xét và ra quyết định.\n4. Quyết định nghỉ hưu ở tuổi cao hơn được gửi các bên liên quan trước thời điểm nghỉ hưu ít nhất 03 tháng.\n5. Căn cứ quyết định, cơ sở giáo dục thực hiện ký kết văn bản thỏa thuận hoặc phụ lục hợp đồng làm việc với nhà giáo về các chế độ, chính sách.',
          summary: [
            'Nhà giáo muốn nghỉ hưu muộn: nộp hồ sơ trước ít nhất 6 THÁNG.',
            'Thời hạn xét duyệt: 30 ngày làm việc; quyết định thông báo trước ít nhất 3 THÁNG.',
          ],
    ...
    {
      number: 'Chương VI',
      title: 'Trình độ chuẩn được đào tạo, đào tạo bồi dưỡng đối với nhà giáo',
      articles: [
        {
          id: 'nd93-d20',
          number: 'Điều 20',
          ...
          examFocus: 'Giáo viên môn đặc thù (Âm nhạc, Mĩ thuật tiểu học): có thể dùng bằng CĐ + Chứng chỉ NVSP thay bằng Cử nhân, nhưng phải nâng chuẩn sau tuyển dụng.',
          isNew2026: true,
        },
        {
          id: 'nd93-d21',
          ...
          content: '1. Đào tạo đáp ứng trình độ chuẩn và đào tạo nâng cao:\na) Đào tạo đáp ứng chuẩn: theo lộ trình của Chính phủ;\nb) Đào tạo nâng cao: theo nguyện vọng cá nhân và nhu cầu, điều kiện của cơ sở giáo dục;\nc) Trong thời gian đào tạo: nhà giáo vẫn được bố trí giảng dạy và hưởng chế độ, chính sách theo quy định.\n2. Bồi dưỡng theo chuẩn nghề nghiệp:\na) Chương trình được xây dựng tương ứng với chức danh nhà giáo;\nb) Thời gian thực hiện mỗi chương trình bồi dưỡng chuẩn nghề nghiệp: tối đa 06 tuần.\n3. Bồi dưỡng theo tiêu chuẩn chức vụ lãnh đạo, quản lý:\na) Nhà giáo được quy hoạch, bổ nhiệm hiệu trưởng/phó hiệu trưởng phải bồi dưỡng nghiệp vụ quản lý giáo dục;\nb) Thời gian: tối đa 01 tuần.\n4. Bồi dưỡng thường xuyên:\na) Thực hiện hằng năm để cập nhật kiến thức, kỹ năng;\nb) Thời gian: tối đa 03 tuần mỗi năm học.',
          summary: [
            '3 loại bồi dưỡng: chuẩn nghề nghiệp (tối đa 6 tuần); quản lý (tối đa 1 tuần); thường xuyên (tối đa 3 tuần/năm).',
            'Trong thời gian đào tạo, nhà giáo vẫn được dạy học và hưởng đầy đủ chế độ.',
          ],
